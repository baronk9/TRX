...
import { Bell, Search, User, Activity, TrendingUp, AlertTriangle, Calendar, BarChart2, Globe, Layers } from 'lucide-react';
      ...
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-[#0a0a0a]/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight text-white">MarketMind <span className="text-indigo-400">AI</span></span>
          </div>
